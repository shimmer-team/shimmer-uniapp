...
exports.default = (options) => {
    ...
    return [
        (options) => {
            var _a;
            return (0, mainJs_1.uniMainJsPlugin)((_a = options.vueOptions) === null || _a === void 0 ? void 0 : _a.script);
        },
        (0, manifestJson_1.uniManifestJsonPlugin)(options),
        (0, pagesJson_1.uniPagesJsonPlugin)(options),
        (0, entry_1.uniEntryPlugin)(options),
        (0, uni_cli_shared_1.uniViteInjectPlugin)((0, shared_1.extend)({}, options.vite.inject)),
        (0, renderjs_1.uniRenderjsPlugin)({ lang: (_a = options.template.filter) === null || _a === void 0 ? void 0 : _a.lang }),
        (0, runtimeHooks_1.uniRuntimeHooksPlugin)(),
        (0, plugin_1.uniMiniProgramPlugin)(options),
        (options) => {
            var _a;
            return (0, usingComponents_1.uniUsingComponentsPlugin)((_a = options.vueOptions) === null || _a === void 0 ? void 0 : _a.script);
        },
