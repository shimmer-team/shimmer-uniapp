        ...
        async transform(source, id) {
            ...
            if (query.vue) {
                if (query.type === 'script') {
                    ...
                    (0, uni_cli_shared_1.updateMiniProgramComponentsByScriptFilename)(filename, inputDir);
                    ...
                    (0, uni_cli_shared_1.updateMiniProgramComponentsByTemplateFilename)(filename, inputDir);
                    return (0, uni_cli_shared_1.transformDynamicImports)(source, descriptor.imports, dynamicImportOptions);
                }
                return null;
            }
            ...
            const descriptor = await (0, uni_cli_shared_1.parseMainDescriptor)(filename, ast, this.resolve);
            (0, uni_cli_shared_1.updateMiniProgramComponentsByMainFilename)(filename, inputDir);
            return (0, uni_cli_shared_1.transformDynamicImports)(source, descriptor.imports, dynamicImportOptions);
        },
    };
}
