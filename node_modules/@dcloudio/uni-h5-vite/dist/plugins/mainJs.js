    ...
    return (0, uni_cli_shared_1.defineUniMainJsPlugin)((opts) => {
        ...
        return {
            ...
            configResolved(config) {
                pagesJsonJsPath = (0, uni_cli_shared_1.normalizePath)(path_1.default.resolve(process.env.UNI_INPUT_DIR, 'pages.json.js'));
                runSSR =
                    (0, utils_1.isSsr)(config.command, config) || (0, utils_1.isSsrManifest)(config.command, config);
            },
