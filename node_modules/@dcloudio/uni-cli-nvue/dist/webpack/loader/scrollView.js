...
function scrollViewLoader(content, map) {
    ...
    let resourcePath = (0, uni_cli_shared_1.removeExt)((0, uni_cli_shared_1.normalizePath)(path_1.default.relative(process.env.UNI_INPUT_DIR, this.resourcePath)));
    if (!process.UNI_NVUE_ENTRY[resourcePath] &&
        this._module.issuer &&
        this._module.issuer.issuer) {
        // <template src=""/>
        resourcePath = (0, uni_cli_shared_1.removeExt)((0, uni_cli_shared_1.normalizePath)(path_1.default.relative(process.env.UNI_INPUT_DIR, this._module.issuer.issuer.resource)));
    }
    // 是否 disableScroll
