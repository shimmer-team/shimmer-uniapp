...
const UniAppNVuePlugin = () => {
    ...
    return {
        ...
        config() {
            ...
            pagesJsonPath = (0, uni_cli_shared_1.normalizePath)(path_1.default.resolve(process.env.UNI_INPUT_DIR, 'pages.json'));
            if (process.env.NODE_ENV === 'production') {
                return (0, webpack_1.runWebpackBuild)().then(() => { });
            }
            return (0, webpack_1.runWebpackDev)().then((compiler) => {
