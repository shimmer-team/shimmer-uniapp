...
function initPluginUniOptions(UniVitePlugins) {
    ...
    UniVitePlugins.forEach((plugin) => {
        const { compiler: pluginTemplateCompiler, copyOptions: pluginCopyOptions, compilerOptions: pluginCompilerOptions, jsxOptions: pluginJsxOptions, } = plugin.uni || {};
...
function initPlugin({ id, config: { main } }, options) {
    let plugin = require(path_1.default.join(id, main || '/lib/uni.plugin.js'));
