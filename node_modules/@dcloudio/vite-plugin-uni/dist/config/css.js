...
function resolvePostcssConfig(inputDir) {
    return [
        path_1.default.resolve(inputDir, 'postcss.config.js'),
        path_1.default.resolve(process.cwd(), 'postcss.config.js'),
    ].find((file) => fs_extra_1.default.existsSync(file));
}
